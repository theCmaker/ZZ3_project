...
// ---------------------------------------------------------------------------------------------------------------------
template <typename Policy>
MoveExtract<Policy>::MoveExtract(Problem & p, const Mobile & m_out, int m_prev, const Interceptor & i) : Move<Policy>(p), _mobile_out(m_out), _mobile_prev(m_prev), _interceptor(i) {}
